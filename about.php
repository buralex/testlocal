    ...
    <div class="wrapper">
      ...
      <div class="main-container ">
        ...
        <div class="content cont-fluid">
          ...
          <!-- content__about -->
          <div class="xs-24 sm-17 content__about-wrap">
          ...
          <!-- content__sidebar -->  
          <div class="content__sidebar-wrap xs-24 sm-7 ">
            <aside class="content__sidebar">
              <div class="welcome">
                <h3>Welcome Guest!</h3>
                <div class="welcome__text">
                  <img class="img-resp frame" src="img/sidebar-blog-main.png" title="Cross-Browser" alt="Cross-Browser" width="222" height="98">
